    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm sm:rounded-lg">
            <div class="p-6 text-blue-700">
                ...
                <h3 class=" font-bold text-xl leading-5 text-blue-800 dark:text-white  mt-2">Que Dios, quien nos da
                    seguridad, los llene de alegría. Que les dé la paz que trae el confiar en él. Y que, por el poder
                    del Espíritu Santo, los llene de esperanza.</h3>
            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded shadow-lg py-5 px-7">
                        <nav class="flex justify-between">
                            ...
                            <ul class="hidden md:flex flex-auto space-x-2">
                                @can('lives.index')
                                <a href="{{ url('/lives') }}">
                                    <li class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-blue-700 border border-blue-700 bg-gray-50 cursor-pointer px-3 py-2.5 font-normal text-sm leading-3 shadow-md rounded">
                                        Transmisiones
                                    </li>
                                </a>
                                @endcan
                        ...
                        <div class="block md:hidden w-full mt-5">
                            <div onclick="selectNew()"
                                 class="cursor-pointer px-4 py-3 text-white bg-blue-700 rounded flex justify-between items-center w-full">
                            ...
                            <div class="relative">
                                <ul id="list"
                                    ...
                                    @can('lives.index')
                                    <a href="{{ url('/lives') }}">
                                        <li class="px-4 py-3 text-gray-600 bg-gray-50 border border-gray-50 focus:outline-none focus:bg-gray-100 hover:bg-gray-100 duration-100 cursor-pointer text-sm leading-3 font-normal focus:text-black">
                                            Transmisiones
                                        </li>
                                    </a>
                                    @endcan
