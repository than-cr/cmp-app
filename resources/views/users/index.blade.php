                        ...
                        <table id="tb_user" class="w-full whitespace-nowrap" style="display: block ;overflow-x: auto;">
                            ...
                            <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 dark:border-gray-600 rounded">
                                ...
                                <td class="text-center">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-blue-700 dark:text-white  mr-2">Nombre Completo</p>
                                    </div>
                                </td>
                                ...
                                <td class="content-center" style="width: 20%">
                                    <div class="flex items-center pl-5">
                                        <p class="text-base font-medium leading-none text-blue-700 dark:text-white  mr-2">Gedeón</p>
                                    </div>
                                </td>
                            ...
                            @foreach($users as $user)
                                <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 dark:border-gray-600  rounded">
                                    ...
                                    <td class="">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 dark:text-white  mr-2">{{ $user->name }} {{ $user->lastName }} {{ $user->motherLastName }}</p>
                                        </div>
                                    </td>
                        ...
                        <table class="w-full whitespace-nowrap" style="display: block ;overflow-x: auto;">
                            ...
                            @foreach($users as $user)
                                <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 dark:border-gray-600  rounded">
                                    ...
                                    <td class="">
                                        <div class="flex items-center pl-5">
                                            <p class="text-base font-medium leading-none text-gray-700 dark:text-white  mr-2">{{ $user->name }} {{ $user->lastName }}</p>
                                        </div>
                                    </td>
